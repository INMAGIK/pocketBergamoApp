(function(){
    ...
    .factory('indexService', [ '$q', '$http', 'iconsService', '$rootScope', function($q, $http, iconsService, $rootScope){
        ...
        svc.getFeaturesPaginated= function(layerName, from){
            ...
            return {
                features : _.reject(f2, function(item){
                    return (!!!item[att]);
                }),
                num : n
            }
        ...
        var searchLayer = function(layerName, term, field){
            ...
            return _.reject(out, function(item){
                ...
                var l2 = removeDiacritics(l);
                //console.log("jjj", l2, l)
                if( l2 == l){
                    var t2 = removeDiacritics(t);    
                    return (t.indexOf(l) == -1 && t2.indexOf(l) == -1);
                }
